  ...
  return (
    <button onClick={() => onClick(book)} className="group text-left w-full focus:outline-none">
      <div className={`bg-white border border-gray-100 overflow-hidden transition-all duration-300 group-hover:-translate-y-0.5 group-hover:shadow-lg ${!available ? 'opacity-60' : ''}`}>
        ...
        {/* ── Couverture — aspect 2:3, image absolue pour éviter tout débordement ── */}
        <div
        ...
        >
          {hasCover ? (
            <img
              ...
              className={`
                ...
                shadow-[4px_4px_10px_rgba(0,0,0,0.12)]
              ...
              style={{
                ...
                display:        'block',
                borderRadius:   0,           /* coins DROITS stricts */
              }}
            />
          ) : (
          ...
          {/* ── Badge glassmorphism — directement sur l'image ── */}
          {available ? (
            <div className="absolute top-2 right-2 bg-green-50/80 backdrop-blur-md px-2 py-0.5 rounded-md border border-green-200/40">
              <span className="text-green-800 font-semibold tracking-wider text-[10px] uppercase">
                Disponible
              </span>
            </div>
          ) : (
            <>
              ...
              <div className="absolute top-2 right-2 bg-gray-100/80 backdrop-blur-md px-2 py-0.5 rounded-md border border-gray-200/40">
                <span className="text-gray-600 font-semibold tracking-wider text-[10px] uppercase">
                  Indisponible
                </span>
              </div>
            </>
        ...
        {/* ── Zone texte — hauteur fixe min-h-[115px] pour alignement parfait ── */}
        <div className="p-3 min-h-[115px] flex flex-col">
          ...
          {/* Badge catégorie — en bas, tous alignés */}
